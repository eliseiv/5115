...
| GET DELETE | /v1/images (список), /v1/images/{imageId} (байты; DELETE — удаление своего изображения) | images ([ADR-058](../../adr/ADR-058-image-generation.md)) | [API-REFERENCE §27](../../API-REFERENCE.md) |
